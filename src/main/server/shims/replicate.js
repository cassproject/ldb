...
let mePpk = process.env.CASS_REPLICATION_PPK || process.env.REPLICATION_PPK || keyFor('replicateAdapter');
let replicateEndpoint = process.env.CASS_REPLICATION_ENDPOINT || process.env.REPLICATION_ENDPOINT || null;
let replConfig = {};
let sizeWindow = 100;
...
let replicateConfigFilePath = 'etc/adapter.replication.json';
let replicateConfig = function() {
